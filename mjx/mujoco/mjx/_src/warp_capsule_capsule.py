...
from .collision_convex import collider
...
def capsule_capsule_opt(m: Model, d: Data, key: FunctionKey, geom: jax.Array) -> Collision:
    
  geom1, geom2 = geom.T
  g1 = GeomInfo(d.geom_xpos[geom1], d.geom_xmat[geom1], m.geom_size[geom1])
  g2 = GeomInfo(d.geom_xpos[geom2], d.geom_xmat[geom2], m.geom_size[geom2])
  ...
  ret_val = capsule_capsule_warp(jpos1, jmat1, jsize1, jpos2, jmat2, jsize2)
  ret_val_squeezed = jp.squeeze(ret_val[0]),jp.squeeze(ret_val[1]),jp.squeeze(ret_val[2])
  print("ret_val=",ret_val)
  print("ret_val_squeezed=",ret_val_squeezed)
  return ret_val_squeezed
